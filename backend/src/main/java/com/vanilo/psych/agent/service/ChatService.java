...
public class ChatService {
    ...
    public ChatService(LlmService llmService, KnowledgeService knowledgeService) {
    ...
    public String ragChat(String message, String memoryContext){
        return ragChat(message, memoryContext, null);
    }

    public String ragChat(String message, String memoryContext, String rolePrompt){
...
4. 高风险表达时，建议联系可信任的人或本地紧急支持，但不要制造恐慌。
                    ...
                    用户问题：
                    %s
                    """.formatted(valueOrDefault(memoryContext, "暂无"), valueOrDefault(rolePrompt, "默认风格"), knowledgeContext, message));
    }
    ...
    public String plainChat(String message, String memoryContext){
        return plainChat(message, memoryContext, null);
    }

    public String plainChat(String message, String memoryContext, String rolePrompt){
        ...
        return llmService.complete("""
                       ...
                       """, """
                        ...
                        用户消息：
                        %s
                        """.formatted(valueOrDefault(memoryContext, "暂无"), valueOrDefault(rolePrompt, "默认风格"), message));
    }
